...
class SmallCap(PreTrainedModel):
    ...
    def __init__(
        ...
        if featdim == None:
            featdim = config.backbone_featdim
        self.linear_layer = nn.Linear(featdim,config.decoder.hidden_size)
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs
        ...
        # make sure input & output embeddings is not tied
        config.tie_word_embeddings = False
        return cls(encoder=encoder, decoder=decoder, config=config,featdim=featdim)
    ...
    def forward(
        ...
        **kwargs,
        ...
        encoder_hidden_states = self.linear_layer(encoder_hidden_states)
        # else:
